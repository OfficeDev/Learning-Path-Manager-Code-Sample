...
<asp:Content ID="Content4" ContentPlaceHolderID="PlaceHolderMain" runat="server">
  <table>
    <tr>
      <td>Learning Path Approver:       
        <br />
        <SharePoint:PeopleEditor runat="server" AllowEmpty="False" ValidatorEnabled="True" MultiSelect="False" ID="peoplePicker" />
        <br />
      </td>
    </tr>
    <tr>
  ...
  <script type="text/javascript">
    ...
    function StartWorkflow() {
      ...
      if (subscriptionId == null || subscriptionId == "") {
        ...
        wfParams['ApproverLoginName'] = $("#divEntityData", html).attr("key");
